...
namespace Cemetery\Registrar\Application\Command\CreateBurial;
 ...
 */
class CreateBurialService extends ApplicationService
{
    ...
    {
        $this->assertInstanceOf($request, CreateBurialRequest::class);
