...
class BurialCollectionTest extends AbstractEntityCollectionTest
{
    public function setUp(): void
    {
        ...
        $this->entityA      = new Burial($this->idA, $burialCodeA, $naturalPersonIdA, $customerId, $siteIdA, null, null, null);
        $this->entityB      = new Burial($this->idB, $burialCodeB, $naturalPersonIdB, $customerId, $siteIdB, $naturalPersonIdB, null, $burialContainerIdB);
        $this->entityC      = new Burial($this->idC, $burialCodeC, $naturalPersonIdC, $customerId, $siteIdC, $naturalPersonIdC, $funeralCompanyIdC, $burialContainerIdC);
        $this->entityD      = new Burial($this->idD, $burialCodeD, $naturalPersonIdD, $customerId, null, null, null, null);
