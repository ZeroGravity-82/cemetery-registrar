...
use Cemetery\Registrar\Infrastructure\Persistence\Pdo\MySql\Fetcher\DoctrineDbalOrganizationFetcher;
...
//        $this->funeralCompanyFetcher->getViewById('unknown_id');
    ...
    public function testItFailsToReturnOrganizationViewForRemovedOrganization(): void
    {
        // Prepare database table for testing
        $funeralCompanyToRemove = $this->juristicPersonRepo->findById(new FuneralCompanyId('FC004'));
